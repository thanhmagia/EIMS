package com.isoftsc.eims.web.rest;

import com.isoftsc.eims.config.Constants;
import com.isoftsc.eims.EimsApp;
import com.isoftsc.eims.domain.Authority;
import com.isoftsc.eims.domain.PersistentToken;
import com.isoftsc.eims.domain.User;
import com.isoftsc.eims.repository.AuthorityRepository;
import com.isoftsc.eims.repository.PersistentTokenRepository;
import com.isoftsc.eims.repository.UserRepository;
import com.isoftsc.eims.security.AuthoritiesConstants;
import com.isoftsc.eims.service.MailService;
import com.isoftsc.eims.service.dto.UserDTO;
import com.isoftsc.eims.service.dto.PasswordChangeDTO;
import com.isoftsc.eims.web.rest.errors.ExceptionTranslator;
import com.isoftsc.eims.web.rest.vm.KeyAndPasswordVM;
import com.isoftsc.eims.web.rest.vm.ManagedUserVM;
import com.isoftsc.eims.service.UserService;
...
@SpringBootTest(classes = EimsApp.class)
