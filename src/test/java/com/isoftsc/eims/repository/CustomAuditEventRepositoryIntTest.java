package com.isoftsc.eims.repository;

import com.isoftsc.eims.EimsApp;
import com.isoftsc.eims.config.Constants;
import com.isoftsc.eims.config.audit.AuditEventConverter;
import com.isoftsc.eims.domain.PersistentAuditEvent;
...
import static com.isoftsc.eims.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
